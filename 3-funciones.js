...
let respuesta = esMayorDeEdad(15)
console.log("es mayor de edad", respuesta);
...
let multiplicarAmbos = multiplicar(7, 2)
console.log(multiplicarAmbos)
...
let nombreApellido = saludarPersonalizado("Pablo", "Gabriel")
...
console.log(saludarFlecha("martin"))
